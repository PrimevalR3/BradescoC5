...
data class CreateCollateralToken(
...
@InitiatingFlow(protocol = "finalize-create-collateral-flow")
class IssueCollateralTokenFlow(): AbstractFlow(), ClientStartableFlow {
    @Suspendable
...
@InitiatedBy(protocol = "finalize-create-collateral-flow")
class FinalizeCreateCollateralTokenFlow: AbstractFlow(), ResponderFlow {

...
@InitiatingFlow(protocol = "finalize-request-loan-flow")
class RequestLoanFlow(): AbstractFlow(), ClientStartableFlow {
    @Suspendable
    override fun call(requestBody: ClientRequestBody): String {
        logger.info("${this::class.java.enclosingClass}.call() called")
        try {
            val myInfo = memberLookup.myInfo()
            val flowArgs = requestBody.getRequestBodyAs(json, LoanRequest::class.java)
            ...
            val requestLoanState = LoanState(
            ...
            val txBuilder = ledgerService.createTransactionBuilder()
                ...
                .addOutputState(requestLoanState)
...
@InitiatedBy(protocol = "finalize-request-loan-flow")
class FinalizeRequestLoanResponderFlow: AbstractFlow(), ResponderFlow {
